...
describe('LoginModule', () => {
  ...
  test('displays validation errors for invalid inputs', async () => {
    ...
    expect(await screen.findByText('Email harus memiliki setidaknya 4 karakter')).toBeInTheDocument();
    expect(await screen.findByText('Kata sandi harus memiliki setidaknya 6 karakter')).toBeInTheDocument();
  });
