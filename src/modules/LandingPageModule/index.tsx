...
export const LandingPageModule: React.FC = () => {
  return (
    ...
    >
      <div className="slay absolute flex items-center justify-center overflow-hidden">
        <div></div>
        <div></div>
        <div></div>
        <div></div>
      ...
      <div
        ...
        className="relative z-10 flex items-center justify-start lg:w-1/2 max-sm:pt-8"
      >
        <img
          src="/landingPage/hero.png"
          alt="Hero"
          className="animate-float-vertical z-10 lg:-mb-10 ml-12 scale-110 md:scale-115 lg:scale-120"
        />

        <div
          data-testid="animated-border"
          className="border-rencanakan-premium-gold-400 animate-glow absolute ml-12 h-[320px] sm:h-[500px] lg:h-[500px] xl:h-[560px] w-[800px] rotate-[2deg] rounded-xl border-6 will-change-transform lg:-mb-6 lg:ml-20"
        />
      </div>
    </div>
  );
