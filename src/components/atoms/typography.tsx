...
const typographyVariants = cva('text-ellipsis', {
  variants: {
    variant: {
        ...
        small: 'xxl:text-[0.7rem] xxl:leading-[calc(0.7rem*1.5)] xl:text-[0.65rem] xl:leading-[calc(0.65rem*1.5)] md:text-[0.6rem] md:leading-[calc(0.6rem*1.5)] text-[0.55rem] leading-[calc(0.55rem*1.5)]',
    },
  },
