...
const typographyVariants = cva('text-ellipsis', {
  variants: {
    variant: {
      d1: 'xxl:text-[4rem] xxl:leading-[calc(4rem*1)] xl:text-[3.5rem] xl:leading-[calc(3.5rem*1)] md:text-[2rem] md:leading-[calc(2rem*1)] text-[1.75rem] leading-[calc(1.75rem*1)]',
      ...
      h1: 'xxl:text-[2.5] xxl:leading-[calc(2.5rem*1.2)] xl:text-[2.2rem] xl:leading-[calc(2.2rem*1.2)] md:text-[2rem] md:leading-[calc(2rem*1.2)] text-[1.75rem] leading-[calc(1.75rem*1.2)] font-extrabold',
      h2: 'xxl:text-[2rem] xxl:leading-[calc(2rem*1.2)] xl:text-[1.85rem] xl:leading-[calc(1.85rem*1.2)] md:text-[1.5rem] md:leading-[calc(1.5rem*1.2)] text-[1.25rem] leading-[calc(1.25rem*1.2)] font-extrabold',
      h3: 'xxl:text-[1.75rem] xxl:leading-[calc(1.75rem*1.2)] xl:text-[1.6rem] xl:leading-[calc(1.6rem*1.2)] md:text-[1.4rem] md:leading-[calc(1.4rem*1.2)] text-[1.1rem] leading-[calc(1.1rem*1.2)] font-extrabold',
      h4: 'xxl:text-[1.5rem] xxl:leading-[calc(1.5rem*1.2)] xl:text-[1.4rem] xl:leading-[calc(1.4rem*1.2)] md:text-[1.3rem] md:leading-[calc(1.3rem*1.2)] text-[1.1rem] leading-[calc(1.1rem*1.2)] font-extrabold',
      h5: 'xxl:text-[1.25rem] xxl:leading-[calc(1.25rem*1.2)] xl:text-[1.2rem] xl:leading-[calc(1.2rem*1.2)] md:text-[1.1rem] md:leading-[calc(1.1rem*1.2)] text-[1rem] leading-[calc(1rem*1.2)] font-extrabold',
      h6: 'xxl:text-[1.125rem] xxl:leading-[calc(1.125rem*1.2)] xl:text-[1.1rem] xl:leading-[calc(1.1rem*1.2)] md:text-[1rem] md:leading-[calc(1rem*1.2)] text-[0.9rem] leading-[calc(0.9rem*1.2)] font-extrabold',
