...
const typographyVariants = cva('text-ellipsis', {
  variants: {
    variant: {
      d1: 'xxl:text-[4rem] xxl:leading-[calc(4rem*1)] xl:text-[3.5rem] xl:leading-[calc(3.5rem*1)] md:text-[3rem] md:leading-[calc(3rem*1)] text-[2.5rem] leading-[calc(2.5rem*1)] font-semibold',
      d2: 'xxl:text-[3.5rem] xxl:leading-[calc(3.5rem*1)] xl:text-[3rem] xl:leading-[calc(3rem*1)] md:text-[2.5rem] md:leading-[calc(2.5rem*1)] text-[2rem] leading-[calc(2rem*1)] font-semibold',
