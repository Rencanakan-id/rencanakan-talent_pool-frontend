...
const inputVariants = cva(
  'flex rounded-[2px] border border-rencanakan-base-gray bg-transparent px-3 py-[9px] text-rencanakan-main-black text-[13px] placeholder:text-rencanakan-dark-gray placeholder:text-[13px] outline-none w-full',
  {
    variants: {
      hasPrefix: {
        true: 'pl-8',
